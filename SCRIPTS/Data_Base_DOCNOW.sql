...
CREATE TABLE Cita (
    ...
    notas NVARCHAR(500) DEFAULT 'Cita agendada.',
...
VALUES
('ANGEL JOAQUIN', 'GARCIA', 'VELAZQUEZ', 'angel@gmail.com', 'angelito', '6871167363', '2006-09-29', 'M', 'ADMIN', GETDATE(), GETDATE()),
('LAURA GUADALUPE', 'GARCIA', 'VELAZQUEZ', 'laura@gmail.com', 'laurita', '6871123422', '1988-05-10', 'F', 'MEDICO', GETDATE(), GETDATE()),
('ALEJANDRO', 'PARRA', 'LEYVA', 'jando@gmail.com', 'jandito', '6671458580', '1985-02-18', 'M', 'MEDICO', GETDATE(), GETDATE()),
('OSVALDO', 'LLANEZ', 'LUQUE', 'osvaldo@gmail.com', 'osvaldito', '6871320944', '2000-07-07', 'M', 'PACIENTE', GETDATE(), GETDATE()),
('JOSE LUIS', 'SOTELO', 'GONZALEZ', 'joseluis@gmail.com', 'luisito', '6871234560', '2001-06-01', 'M', 'PACIENTE', GETDATE(), GETDATE());
GO
...
(1, 1, 1, 2, '2025-12-15', '08:30', '09:00', 'AGENDADA', 'Cita agendada por el paciente.'),
(1, 2, 2, 6, '2025-12-13', '16:30', '16:45', 'AGENDADA', 'Cita agendada por el paciente.'),
(1, 1, 1, 2, '2025-12-18', '09:30', '10:00', 'CANCELADA', 'Cita cancelada por el paciente.'),
(1, 2, 2, 7, '2025-12-31', '12:45', '13:00', 'AGENDADA', 'Cita agendada por el paciente.'),

-- El paciente Raul tiene una cita agendada y una cita cancelada por si mismo
(2, 1, 2, 2, '2025-11-25', '17:30', '18:00', 'COMPLETADA', 'Su presión arterial está en los niveles adecuados, se le recomendó mayor insumo de frutas y carbohidratos.'),
(2, 1, 2, 4, '2025-11-30', '15:00', '15:15', 'AGENDADA', 'Cita agendada por el paciente.'),
